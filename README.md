...
-BepInEx version 5.4.23.4 (x64 version) (https://github.com/BepInEx/BepInEx/releases) (called BepInEx_win_x64_5.4.23.4.zip) <br/>
...
### BepInEx
BepInEx: Install the 5.4.23.4 x64 version - (https://github.com/BepInEx/BepInEx/releases)<br/>
